          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 mt-auto">
                ...
                <Button asChild className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-6">
                    <a href="tel:4807426827" className="flex items-center justify-center gap-2">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" type="tel" placeholder="(480) 742-6827" required className="rounded-xl py-6" />
                </div>
